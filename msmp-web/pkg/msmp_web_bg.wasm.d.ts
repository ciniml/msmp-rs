...
export function run_service(a: number, b: number): number;
...
export function closure76_externref_shim(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __externref_table_alloc(): number;
export function closure97_externref_shim(a: number, b: number, c: number, d: number): void;
